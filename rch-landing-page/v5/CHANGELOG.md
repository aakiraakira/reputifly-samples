...
## [v5] — 2026-04-26
- Hero building photo now displays in full (removed max-height crop and object-fit: cover - was showing only partial building)
- Floor Plans accordion: split combined "Level 3 & 2" into separate Level 3 and Level 2 entries
- Floor Plans accordion: split combined "Level 1 & Ground Floor" into separate Level 1 and Ground Floor entries
- Location Map: removed 1000px max-width to display map at full container width
- Enquiry form: replaced single PDPA checkbox with two specific consent checkboxes:
  1. "I agree to receive future communications from DSA Development"
  2. "I have understood and accepted the Privacy Policy and Disclaimer Notice and Personal Data Protection Notification"
- Footer/Contact section: changed dark background (#0a1710) to light background (#f5f7f6) for better readability
- Updated form input styling for light footer (white inputs, dark text, gold focus ring)
- Updated developer info, disclaimers, and headings color scheme for light footer
