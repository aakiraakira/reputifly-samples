...
const PetCremation = () => {
  const inclusions = ["Compassionate pet collection", "Individual cremation", "Urn options available", "Ashes return", "Memorial keepsakes"];
  return (
    <><Header /><main className="pt-20 pb-24">
      <section className="py-12 bg-grad-calm"><div className="container mx-auto px-4">
        <nav className="text-sm text-slate-600 mb-4"><Link to="/" className="hover:text-primary">Home</Link> / Pet Cremation</nav>
        <h1 className="text-4xl md:text-5xl font-heading font-bold text-ink mb-6">Pet Cremation Services</h1>
        <p className="text-xl text-slate-600 max-w-3xl">Compassionate farewell services for your beloved pets.</p>
      </div></section>
      <section className="py-16 bg-paper"><div className="container mx-auto px-4 max-w-4xl">
        <h2 className="text-3xl font-heading font-bold text-ink mb-6">Honoring Your Beloved Companion</h2>
