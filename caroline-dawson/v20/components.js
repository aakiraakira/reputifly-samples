        ...
        <ul class="nav-links" id="nav-links">
            ...
            <li class="nav-has-dropdown">
                ...
                <ul class="nav-dropdown">
                    ...
                    <li class="nav-dropdown-heading">Strategic Communication &amp; Presence</li>
                    ...
                    <li class="nav-dropdown-heading">Executive Leadership &amp; Emotional Intelligence</li>
                    ...
                    <li class="nav-dropdown-heading">Adaptive Thinking &amp; Problem Solving</li>
            ...
            <li><a href="consultancy.html">Workplace Learning Consultancy</a></li>
...
<div class="footer-content">
    <div class="footer-col">
        ...
        <div class="social-links" style="margin-top: 20px;">
            <a href="https://www.linkedin.com/company/cdi-page" target="_blank" aria-label="CDI on LinkedIn"><i class="fab fa-linkedin-in"></i></a>
        </div>
    </div>
    ...
    <div class="footer-col">
        ...
        <div class="footer-links">
            ...
            <a href="assets/lead-magnet/5-communication-breakdowns.pdf" target="_blank">Free E-Book</a>
        </div>
    </div>
</div>
