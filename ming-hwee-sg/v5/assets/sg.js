...
(function () {
  ...
  // ---- FLOW D: Helper application (PH-oriented) ----
  // All 18 qs from MingHwee_Filipino_Helper_Application.jsx, minus the otp step.
  var HELPER_QS = [
    { id: 'name', bk: 'About You', q: "What's your name?", ty: 'text', ph: 'Your full name', req: true },
    { id: 'mobile', bk: 'About You', q: "What's your mobile or WhatsApp number?", sub: "We'll use this to contact you for an interview", ty: 'tel', ph: '+63 9XX XXX XXXX', req: true },
    // (otp step skipped — no SMS backend)
    { id: 'email', bk: 'About You', q: 'Your email address (optional)', ty: 'email', ph: 'you@example.com', req: false },
    { id: 'location', bk: 'About You', q: 'Which city or province are you in?', sub: 'So we can arrange an interview near you', ty: 'text', ph: 'e.g. Cebu City, Manila, Davao', req: true },
    { id: 'age', bk: 'Basic Details', q: 'How old are you?', ty: 'single', opts: ['Below 23', '23–29', '30–39', '40–50', 'Above 50'], req: true },
    { id: 'marital', bk: 'Basic Details', q: "What's your marital status?", ty: 'single', opts: ['Single', 'Married', 'Widowed', 'Separated'], req: true },
    { id: 'education', bk: 'Basic Details', q: "What's your highest education level?", ty: 'single', opts: ['Elementary', 'High School', 'Vocational / TESDA', 'College / Degree'], req: true },
    { id: 'experience', bk: 'Your Experience', q: 'Have you worked abroad as a domestic helper before?', ty: 'single', opts: ["Yes — I'm experienced", 'No — this is my first time'], req: true },
    { id: 'countries', bk: 'Your Experience', q: 'Which countries have you worked in?', sub: 'Select all that apply', ty: 'multi', opts: ['Singapore', 'Hong Kong', 'Middle East / GCC', 'Malaysia', 'Taiwan', 'Other'], req: true, showIf: function (a) { return a.experience === "Yes — I'm experienced"; } },
    { id: 'years', bk: 'Your Experience', q: 'How many years of experience do you have?', ty: 'single', opts: ['Less than 1 year', '1–2 years', '3–5 years', 'More than 5 years'], req: false, showIf: function (a) { return a.experience === "Yes — I'm experienced"; } },
    { id: 'skills', bk: 'Your Skills', q: 'What are you experienced in?', sub: 'Select all that apply', ty: 'multi', opts: ['Newborn / infant care', 'Childcare (toddlers & older)', 'Elderly care', 'Caring for bedridden / disabled', 'Cooking', 'General housework', 'Pet care'], req: true },
    { id: 'cooking', bk: 'Your Skills', q: 'What cuisines can you cook?', sub: 'Select all that apply', ty: 'multi', opts: ['Filipino', 'Chinese', 'Western', 'Indian', 'Malay', 'Willing to learn'], req: false },
    { id: 'english', bk: 'Your Skills', q: 'How would you rate your English?', ty: 'single', opts: ['Basic', 'Conversational', 'Fluent'], req: true },
    { id: 'otherLang', bk: 'Your Skills', q: 'Do you speak any other languages?', sub: 'Select all that apply', ty: 'multi', opts: ['Mandarin', 'Cantonese', 'Malay', 'Arabic', 'None', 'Other'], req: false },
    { id: 'available', bk: 'Availability', q: 'When can you start working?', ty: 'single', opts: ['Immediately', 'Within 1 month', 'Within 2–3 months', 'Just exploring for now'], req: true },
    { id: 'passport', bk: 'Availability', q: 'Do you have a valid passport?', ty: 'single', opts: ['Yes — valid', 'Yes — but expiring soon', 'No — not yet', 'In process'], req: true },
    { id: 'notes', bk: 'Almost Done', q: "Anything else you'd like us to know?", sub: "Tell us about yourself, your strengths, what you're looking for", ty: 'textarea', ph: "e.g. I love working with children and have cared for newborns. I'm hardworking, honest, and a good cook...", req: false }
  ];
  ...
  var FLOWS = {
    ...
    helper: {
      formType: 'sg_helper_application',
      brand: 'Helper Application',
      label: 'Apply to Work',
      ctaType: 'tf-helper',
      intro: {
        eyebrow: 'Work With Us',
        title: 'Apply to work as a helper',
        body: 'Ming Hwee has placed helpers with caring Singapore families for over 40 years. Apply now and our team will reach out to arrange an interview.',
        bullets: [
          ['Quick — 3 minutes', 'Simple questions about you'],
          ['Employers screened', 'We screen families for your safety'],
          ['No placement fees', 'We never charge helpers placement fees']
        ],
      ...
      success: {
        ...
        msg: 'Our team will review your application and contact you to arrange your interview.',
        steps: [
          'Our recruiter reviews your application',
          'We call or message you to connect',
          'We arrange a face-to-face interview',
          'We match you with a screened Singapore family'
        ]
      }
    }
  };
  ...
  function renderIntro() {
    ...
    TF.introEl.querySelector('.tf-start').addEventListener('click', function () {
      ...
      TF.stageEl.style.display = 'block';
