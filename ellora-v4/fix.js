...
files.forEach(file => {
    ...
    if (!content.includes('.footer-logo {')) {
        ...
        content = content.replace(
            ...
            '<img src="https://reputifly3.sg-host.com/wp-content/uploads/2026/03/Ellora-Furnishings-Transparent-Background-mm7m7ot3a1p8.png" alt="Ellora Furnishings" class="footer-logo"'
        );
