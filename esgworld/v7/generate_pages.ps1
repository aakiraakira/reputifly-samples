...
$index_file = Join-Path $base_dir "index.html"

$content = [System.IO.File]::ReadAllText($index_file)

# Split with regex, or just string split
$parts = $content -split "(?i)<main>", 2
$top_template = $parts[0] + "<main>"
$main_content = $parts[1]

$parts2 = $main_content -split "(?i)</main>", 2
$bottom_template = "</main>" + $parts2[1]
...
$top_template = $top_template -replace "</style>", "$additional_css`n</style>"

# ABOUT US
$about_title = "About Us | ESG World"
$about_content = @"
...
"@
$about_html = $top_template -replace "(?i)<title>.*?</title>", "<title>$about_title</title>"
$about_html = $about_html + $about_content + $bottom_template
[System.IO.File]::WriteAllText((Join-Path $base_dir "about.html"), $about_html)


# SERVICES
$services_title = "Services | ESG World"
$services_content = @"
        ...
        <section class="section-padding bg-white">
            <div class="container">
                ...
                <div class="service-detail" id="packaging">
                    <div class="service-content">
...
"@
$services_html = $top_template -replace "(?i)<title>.*?</title>", "<title>$services_title</title>"
$services_html = $services_html + $services_content + $bottom_template
[System.IO.File]::WriteAllText((Join-Path $base_dir "services.html"), $services_html)


# CONTACT US
$contact_title = "Contact Us | ESG World"
$contact_content = @"
...
"@
$contact_html = $top_template -replace "(?i)<title>.*?</title>", "<title>$contact_title</title>"
$contact_html = $contact_html + $contact_content + $bottom_template
[System.IO.File]::WriteAllText((Join-Path $base_dir "contact.html"), $contact_html)
